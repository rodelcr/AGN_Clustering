...
class Zhai17HOD(HaloProfileHOD):
    ...
    __repr_attrs__ = __eq_attrs__ = (
        "log10Mmin_0", "log10Mmin_p", "siglog10M_0", "siglog10M_p", "log10Msat_0",
        "log10Msat_p", "log10Mcut_0", "log10Mcut_p", "alpha_0", "alpha_p", "fc_0",
    ...
    def __init__(self, *, mass_def, concentration,
                 log10Mmin_0=12., log10Mmin_p=0., siglog10M_0=0.4,
                 siglog10M_p=0., log10Msat_0=7., log10Msat_p=0.,
                 log10Mcut_0=13.3, log10Mcut_p=0., alpha_0=1.,
        ...
        self.log10Msat_0 = log10Msat_0
        self.log10Msat_p = log10Msat_p
    ...
    def update_parameters(self, *, log10Mmin_0=None, log10Mmin_p=None,
                          ...
                          log10Msat_0=None, log10Msat_p=None,
        ...
        if log10Mmin_p is not None:
            self.log10Mmin_p = log10Mmin_p
        if log10Msat_0 is not None:
            self.log10Msat_0 = log10Msat_0
        if log10Msat_p is not None:
            self.log10Msat_p = log10Msat_p
    ...
    def _Nc(self, M, a):
        ...
        return 0.5 * (1 + erf((np.log10(M)-np.log10(Mmin))/siglog10M))

    def _Ns(self, M, a):
        # Number of satellites
        Msat = 10.**(self.log10Msat_0 + self.log10Msat_p * (a - self.a_pivot))# Recast as Msat
        Mcut = 10.**(self.log10Mcut_0 + self.log10Mcut_p * (a - self.a_pivot))# Recast as Mcut
        alpha = self.alpha_0 + self.alpha_p * (a - self.a_pivot)
        return ((M/Msat)**alpha) * np.exp(-Mcut/M) #* self._Nc(M, a)