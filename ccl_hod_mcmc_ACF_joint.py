...
x,y,inverse_covmat, zgrid, dNdz = file_prep_ACF(data_path1)
x2,y2,inverse_covmat2, zgrid2, dNdz2 = file_prep_ACF(data_path2)
x3,y3,inverse_covmat3, zgrid3, dNdz3 = file_prep_ACF(data_path3)
